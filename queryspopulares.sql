...
productos.id,
motos.id,
repuestosxmoto.idproducto,
repuestosxmoto.idmoto 
FROM productos,motos,repuestosxmoto 
WHERE (motos.fabricante='Yamaha')AND
(motos.id=repuestosxmoto.idmoto)AND
(repuestosxmoto.idproducto=productos.id);
**************************************************************************************************************************
